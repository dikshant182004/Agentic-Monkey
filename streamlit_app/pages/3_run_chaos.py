...
from streamlit_app.components.api_client import create_run, approve_turn, reject_turn, get_live_state
...
monkeys = st.multiselect(
    "Monkeys",
    ["cti", "tool_vortex", "memory_entropy", "security_storm", "autonomy_probe", "inter_agent", "performance"],
    default=["cti"],
)
